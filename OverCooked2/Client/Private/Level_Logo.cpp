...
#ifdef _DEBUG
	else if (m_pGameInstance->Get_DIKeyState(DIK_SPACE) == EKeyState::DOWN)
	{
		if (FAILED(m_pGameInstance->Open_Level(LEVEL_LOADING, CLevel_Loading::Create(m_pDevice, m_pContext, LEVEL_EDITOR))))
			return;
	}
#endif
}
