...
#pragma region INDEX_BUFFER
	...
	for (_uint i = 0; i < m_iNumVerticesZ - 1; i++)
	{
		for (_uint j = 0; j < m_iNumVerticesX - 1; j++)
		{
			...
			/* 오른쪽 위 삼각형의 인덱스 */
			pIndices[iNumIndices++] = m_pIndices[iNumIndices] = iIndices[0];
			pIndices[iNumIndices++] = m_pIndices[iNumIndices] = iIndices[1];
			pIndices[iNumIndices++] = m_pIndices[iNumIndices] = iIndices[2];

			pIndices[iNumIndices++] = m_pIndices[iNumIndices] = iIndices[0];
			pIndices[iNumIndices++] = m_pIndices[iNumIndices] = iIndices[2];
			pIndices[iNumIndices++] = m_pIndices[iNumIndices] = iIndices[3];
		}
	}
