...
public:
	...
	_float4 Compute_Picking(const class CTransform* pTransform, _float& fDist) const;

private:
	_float3 ComputeTriangleNormal(const _float3& v0, const _float3& v1, const _float3& v2) const;
