...
public:
	...
	HRESULT Add_Clone(_uint iLevelIndex, const wstring& strLayerTag, const wstring& strPrototypeTag, _float4 Position, void* pArg);
	HRESULT Add_Clone(_Out_ class CGameObject** pObject, _uint iLevelIndex, const wstring& strLayerTag, const wstring& strPrototypeTag, void* pArg);
