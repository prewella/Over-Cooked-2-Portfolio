...
public:
	...
	virtual void UpRise(_float fTimeDelta);
	virtual void UpRise_Steam(_float fTimeDelta);
	virtual void Dwarf(_float fTimeDelta);
	virtual void Be_Huge(_float fTimeDelta);
